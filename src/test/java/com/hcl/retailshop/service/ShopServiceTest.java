...
public class ShopServiceTest {
    ...
    public void setup() throws Exception {
        when(coordinateService.getCoordinates(anyString(), anyString())).thenAnswer(new Answer<Coordinates>() {
            @Override
    ...
    public void processShop() throws Exception {
        ...
        verify(coordinateService, times(1)).getCoordinates(anyString(), anyString());
    }
}
